          ...
          <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                              Total number of Reviews : ${total} <br>
                              Review Average Rating : ${rating}<br>
                            </div>
                        </div>
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    	<c:forEach var="Rev" items="${revlist}" varStatus="row">
                                    		<tr>
                                    			<td>${Rev.review_id}</td>
                                    			<td><a href="<c:url value='/hospital/manager_reviewDetail'>
                                    			<c:param name="review_id" value="${Rev.review_id}"/></c:url>">${Rev.detail}</a></td>
                                    			<td align="center">
                                    				<c:choose>
