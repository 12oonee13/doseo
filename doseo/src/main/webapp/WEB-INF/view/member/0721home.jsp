...
<body id="top">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu action-form">
							...
							<button class="btn btn-primary btn-block"
								onclick="location.href = 'member/join'">ADD INFORMATION</button>
						</div>
					</div>
				</div>
				<%
				...
				<div class="col-lg-6 col-md-10 ">
					<div class="appoinment-wrap mt-5 mt-lg-0">
						...
						<form id="#" class="appoinment-form" method="post" action="#">
							...
							<a class="btn btn-main btn-round-full" href="appoinment.html">Make an
								Appointment <i class="icofont-simple-right ml-2  "></i>
							</a>
						</form>
					</div>
					...
					<div class="col-lg-12 testimonial-wrap-2">
						<div class="testimonial-block style-2  gray-bg">
							...
							<div class="client-info ">
								...
								<p>They provide great service facilty consectetur
									adipisicing elit. Itaque rem, praesentium, iure, ipsum magnam
									deleniti a vel eos adipisci suscipit fugit placeat.</p>
							</div>
						</div>
						...
						<div class="testimonial-block style-2  gray-bg">
							...
							<div class="client-info">
								...
								<p class="mt-4">They provide great service facilty
									...
									ipsum magnam deleniti a vel eos adipisci suscipit fugit
									placeat.</p>
							</div>
							<i class="icofont-quote-right"></i>
						</div>
    ...
    =====================================-->
		...
		<!-- Bootstrap 4.3.2 -->
		<script
			src="${pageContext.request.contextPath}/resources/plugins/bootstrap/js/popper.js"></script>
		<script
			src="${pageContext.request.contextPath}/resources/plugins/bootstrap/js/bootstrap.min.js"></script>
		<script
			src="${pageContext.request.contextPath}/resources/plugins/counterup/jquery.easing.js"></script>
		<!-- Slick Slider -->
		<script
			src="${pageContext.request.contextPath}/resources/plugins/slick-carousel/slick/slick.min.js"></script>
		<!-- Counterup -->
		<script
			src="${pageContext.request.contextPath}/resources/plugins/counterup/jquery.waypoints.min.js"></script>

		<script
			src="${pageContext.request.contextPath}/resources/plugins/shuffle/shuffle.min.js"></script>
		<script
			src="${pageContext.request.contextPath}/resources/plugins/counterup/jquery.counterup.min.js"></script>
		<!-- Google Map -->
		<script
			src="${pageContext.request.contextPath}/resources/plugins/google-map/map.js"></script>
		<script
