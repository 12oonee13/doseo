...
<body id="top">
	...
	<section class="section testimonial-2 gray-bg">
		...
		<div class="container">
			<div class="row">
				<c:forEach var="ap" items="${ap_list}">
					<c:if test="${ap.compareDate eq 'after'}">
						<div class="col-lg-4 col-md-6 ">
							<div class="department-block mb-5">
								<div class="content">
									<h4 class="mt-4 mb-2 title-color">${ap.hos_name_eng}</h4>
									<p class="mb-4">${ap.ap_date}</p>
									<a href="<c:url value='appointment_list_detail'>
									<c:param name='ap_id' value='${ap.ap_id}' /></c:url>" class="read-more">
										Detail More<i class="icofont-simple-right ml-2"></i>
										</a>
									</a>
								</div>
							</div>
		...
		<div class="container">
			*Past Reservation
			<div class="row">
				<c:forEach var="ap" items="${ap_list}">
					<c:if test="${ap.compareDate eq 'before'}">
						<div class="col-lg-4 col-md-6 ">
							<div class="department-block mb-5">
								<div class="content">
									<h4 class="mt-4 mb-2 title-color">${ap.hos_name_eng}</h4>
