	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div id="navbarCollapse"
				...
				<div class="navbar-nav">
					<!-- <a href="#" class="nav-item nav-link active">Pricing</a> -->
					<a href="mypage" class="nav-item nav-link">My Page</a> <a
						href="logout" class="nav-item nav-link">Sign out</a>
				</div>
			</div>
		</nav>
	</header>
				...
				<div class="section-title text-center">
					<div class="btn-group btn-group-toggle " data-toggle="buttons">
						<label class="btn active "> <a href="mypage"
							id="mypage_category">My page </a>
						</label> <label class="btn active ">
						 <a href="appointment_list">Appointment </a>
						</label> <label class="btn active "> <a
							href="review_list" id="mypage_category">Review </a>
						</label>
					</div>
					<hr>
					<h2>My page</h2>
					<div class="divider mx-auto my-4"></div>
					<p>update your profile and check your appointments, reviews you
						wrote.</p>
				</div>
			</div>
		</div>
			...
			<div class="row align-items-center">
				<div class="col-lg-12 testimonial-wrap-2">
					<div class="testimonial-block style-2  gray-bg">
						<div id="update_memberInfo">
							<form:form modelAttribute="mypage_update" action="mypage_update">
								<p>Update your profile!</p>
								<div class="form-group">
									id:
									<form:input path="id" value="${userInfo.id}"
										class="form-control" readonly="true" />
								</div>
								<div class="form-group">
									new password:
									<form:password path="password" value="${userInfo.password}"
								...
								<div class="form-group">
									name:
									<form:input path="name" value="${userInfo.name}"
										class="form-control" />
								</div>
								<div class="form-group">
									phone number:
									<form:input path="phone" value="${userInfo.phone}"
										class="form-control" />
								</div>
								...
								<div class="form-group">
									birth:
									<form:select path="age" required="required"
										class="form-control">
										<option selected>${userInfo.age}</option>
										<%
								...
								<div class="form-group">
									nationality:
									<form:select path="nationality" required="required"
										class="form-control">
										<option selected>${userInfo.nationality}</option>
										<optgroup label = "Asia">
